...
public class dbcategories extends SQLiteOpenHelper {
    private static final String dbname="Categories";
    ...
    {
        String qry="create table tbl_contact ( id integer primary key autoincrement, name text, purl image)";
    ...
    public  String addrecord(String name, String purl)
    {
